                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ${
                      order.side === 'BUY' 
                        ...
                        : 'bg-rose-500/10 text-rose-400 border border-rose-500/20 shadow-[0_0_10_rgba(244,63,94,0.05)]'
                    }`}>
                      {order.side}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <div className="relative group/id">
                        <span 
                          className="font-mono text-[9px] text-slate-500 bg-slate-950/50 px-2 py-1 rounded border border-slate-800 cursor-help" 
                          title={order.orderId}
                        >
